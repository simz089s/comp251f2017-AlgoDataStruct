...
\begin{document}
	...
	\section{Stable marriage matching problem}
		...
		\paragraph{b)}
		If every woman has their best choice, then there are two cases. One, every man had a different woman as their first choice, and they are respectively also the first choice of their woman. Second case, every man proposed to every woman. But a woman that has been proposed by her first choice will never change partners after that.
	...
	\section{}
		...
		\paragraph{}
		From the base case, we can see that it should apply for any $c$.
		But in the induction step,
